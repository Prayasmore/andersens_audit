...
const ServiceColumn = ({ label, heading, description, services, outcome }) => {
  return (
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-8 shadow-sm md:p-10">
      <p className="font-sans text-[0.72rem] font-semibold uppercase tracking-[0.34em] text-blue-800">
        {label}
      </p>

      <h3 className="mt-6 font-serif text-3xl font-bold leading-tight text-[#0B1F3A] md:text-4xl">
        {heading}
      </h3>
      ...
      <div className="mt-8 h-px w-full bg-gradient-to-r from-slate-200 to-transparent" />
      ...
      <div className="mt-2 flex-1">
        {services.map((service, index) => (
          ...
          >
            <p className="font-serif text-xl leading-tight text-[#0B1F3A] md:text-2xl">
              {service.title}
            </p>
      ...
      <div className="mt-6 rounded-xl border border-blue-200 bg-blue-50/70 p-5">
...
const Services = () => {
  return (
    <section id="services" className="relative overflow-hidden bg-[#faf8f5]">
      <div className="absolute right-[-10rem] top-10 h-[26rem] w-[26rem] rounded-full bg-blue-100/60 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 md:px-8 md:py-24 lg:px-12 lg:py-32">
        <div className="max-w-4xl">
          ...
          <h2 className="font-serif text-4xl font-bold leading-[1.02] text-[#0B1F3A] md:text-5xl lg:text-6xl">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2 lg:gap-8 lg:items-stretch">
          <ServiceColumn
            ...
            outcome="An independent opinion that stands up to regulators, banks, and boards — delivered on deadline, without surprises."
          />
          <ServiceColumn
            ...
            outcome="Decisions backed by numbers you can defend — to investors, lenders, and your board."
          />
        </div>
      </div>
    </section>
